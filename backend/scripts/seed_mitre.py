...
MITRE_TECHNIQUES = [
    ...
    (
        "T1590.001",
        "Active Scanning: Scan IP Blocks",
        "Reconnaissance",
        "Network",
        "Detect unexpected inbound connections from unknown IPs",
    ...
    (
        ...
        "Reconnaissance",
        "Network",
        "Monitor for vulnerability scanner signatures",
    ...
    (
        ...
        "Reconnaissance",
        "Network",
        "Detect rapid port connection attempts",
        "Port knocking, fail2ban",
    ),
    ...
    (
        ...
        "Resource Development",
        "Multi-platform",
        "Monitor for known tool signatures",
    ...
    (
        ...
        "Initial Access",
        "Multi-platform",
        "WAF alerts, unusual HTTP requests",
        "Patch management, WAF",
    ),
    (
        "T1133",
    ...
    (
        ...
        "Initial Access",
        "Multi-platform",
        "Failed login monitoring, rate limiting",
        "Account lockout, MFA",
    ),
    (
        "T1110.003",
        ...
        "Initial Access",
        "Multi-platform",
        "Single password across multiple accounts",
        "Account lockout, MFA",
    ),
    (
        "T1110.004",
        ...
        "Initial Access",
        "Multi-platform",
        "Known breached credentials usage",
        "Breach monitoring, MFA",
    ),
    # Execution
    (
        "T1059.001",
    ...
    (
        ...
        "Persistence",
        "Web Server",
        "File integrity monitoring, unusual web files",
        "WAF, file monitoring",
    ),
    (
        "T1505.004",
    ...
    (
        ...
        "Privilege Escalation",
        "Multi-platform",
        "Unusual process behavior, CVE exploits",
        "Patch management",
    ),
    (
        "T1548.003",
    ...
    (
        ...
        "Defense Evasion",
        "Multi-platform",
        "Antivirus/EDR tampering alerts",
        "Tamper protection",
    ),
    # Credential Access
    (
    ...
    (
        ...
        "Credential Access",
        "Multi-platform",
        "Browser/manager access monitoring",
        "Hardware tokens",
    ),
    (
        "T1556.002",
        "Modify Authentication Process: Password Filter",
        "Credential Access",
        "Windows",
        "Password filter DLL monitoring",
        "Code signing",
    ),
    # Discovery
    (
    ...
    (
        ...
        "Credential guard, RDP restriction",
    ),
    (
        "T1021.001",
    ...
    (
        ...
        "Collection",
        "Multi-platform",
        "Large file reads, archive creation",
        "DLP, encryption",
    ),
    (
        "T1056.001",
    ...
    (
        ...
        "Command and Control",
        "Multi-platform",
        "HTTP/HTTPS beaconing detection",
        "Proxy inspection",
    ),
    (
        "T1071.004",
    ...
    (
        ...
        "Command and Control",
        "Multi-platform",
        "File download from suspicious sources",
        "Application allowlisting",
    ),
    (
        "T1573.001",
    ...
    (
        ...
        "Exfiltration",
        "Multi-platform",
        "Non-standard protocol transfers",
    ...
    (
        ...
        "Impact",
        "Multi-platform",
        "Backup deletion, shadow copy removal",
        "Immutable backups",
    ),
    (
        "T1499.001",
